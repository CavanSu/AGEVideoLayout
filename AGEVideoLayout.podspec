#
#  Be sure to run `pod spec lint AGEVideoLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "CavanSu"
  # s.authors            = { "CavanSu" => "403029552@qq.com" }
  # s.social_media_url   = "http://twitter.com/CavanSu"
